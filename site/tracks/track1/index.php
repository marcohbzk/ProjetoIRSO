...
<body>
    <div class="container">
        <header class="d-flex justify-content-center py-3">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="../track1/index.php" class="nav-link active" aria-current="page">Pista 1</a></li>
                <li class="nav-item"><a href="../track2/index.php" class="nav-link">Pista 2</a></li>
    ...
    <?php
    $file = trim(file_get_contents("../../../files/track1/available.txt"));
    if ($file == "false")
    ...
    <div class="justify-content-center d-flex">
        <div class="px-4 py-5 my-5 text-center w-50">
            ...
            <?php
            if (file_get_contents("../../../files/track1/available.txt") == "true")
            ...
            <h3>Luz de rua:
                <?php
                if (file_get_contents("../../../files/track1/light.txt") == "2")
            ...
            <div class="row row-cols-1 row-cols-sm-2 g-4">
                <div class="col d-flex flex-column gap-2">
                    ...
                    <p class="text-muted"><?= file_get_contents("../../../files/track1/latestTime.txt") ?>s</p>
                </div>
                ...
                <div class="col d-flex flex-column gap-2">
                    ...
                    <p class="text-muted"><?= file_get_contents("../../../files/track1/recordTime.txt") ?>s</p>
                </div>
            ...
            <div class="container px-4 py-5">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $x = 0;
                        foreach (file("../../../files/logs/track1.txt") as $linha) {
                            $linha = explode(';', $linha); ?>
                            <tr>
                                <th scope="row"><?= $x ?></th>
                                <td><?= $linha[0] ?></td>
